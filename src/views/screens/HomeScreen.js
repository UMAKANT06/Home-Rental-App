...
const HomeScreen = ({navigation}) => {
  ...
  // const ListOptions = () =>{
  //   const optionsList = [
  //     {title: ' Landlord', img: require('../../assets/house1.jpg'),onPress: navigation.navigate('Landlord')},
        ...
        {optionsList.map((option, index) => (
          <Pressable key={index} onPress={option.onPress}>
            <View style={style.optionCard}>
              <Image source={option.img} style={style.optionCarImage} />
              <Text style={{ marginTop: 10, fontSize: 18, fontWeight: 'bold' }}>{option.title}</Text>
            </View>
          </Pressable>
        ))}
    ...
    <SafeAreaView style={{flex:1,backgroundColor:COLORS.white}}>
      ...
      <View style={style.header}>
        <View>
          ...
          <Text style={{color:COLORS.dark,fontWeight:'bold', fontSize:20}}>INDIA</Text>
        </View>
